<template>
  <nuxt-link class="card-link" :to="{path:`/article/${123}`}
  ">
    <div class="blog-card">
      <div class="raduis elevation-9">
      ...
      <div class="article-details">
        ...
        <v-card-text
          class="body-2"
        >研究一个深度学习算法，可以先看网络结构，看懂网络结构后，再Loss计算方法、训练方法等。本文主要讲解UNet网络结构，以及相应代码的代码编写，其它内容会在后续章节进行说明。</v-card-text>
