<template>
  <div ref="preview">
    <div :class="`markdown-preview ${'markdown-theme-' + theme}`" v-html="html"></div>
    <!-- 预览图片-->
...
export default {
  ...
  methods: {
    translateMarkdown () {
      ...
      this.html = html;
      console.log(tocObj.tocItems, 'tocObj.tocItems');
      this.$store.commit('blog/set_toc', tocObj.tocItems)
      tocObj.reset()
